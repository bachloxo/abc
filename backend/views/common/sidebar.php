                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#sidebarNav">
                                Danh mục quản lí <i class="fa fa-angle-up"></i>
                            </a>
                        </h4>
                    </div>
                    <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                        <div class="panel-body">
                            ...
                            ==================================================== -->
                            <ul id="navigation">
                                <li <?php if ($_GET['controller']=='') { ?> class="active" <?php } ?>><a href="admin.php"><i class="fa fa-dashboard"></i> <span>Tổng Quan</span></a></li>
                                <li <?php if ($_GET['controller']=='category') { ?> class="active" <?php } ?>><a href="admin.php?controller=category" role="button" tabindex="0"><i class="fa fa-list"></i> <span>Danh mục</span></a></li>
                                <li <?php if ($_GET['controller']=='blog') { ?> class="active" <?php } ?>><a href="admin.php?controller=blog"role="button" tabindex="0"><i class="fa fa-pencil"></i> <span>Blog</span></a></li>
                                <li <?php if ($_GET['controller']=='product') { ?> class="active" <?php } ?>><a href="admin.php?controller=product" role="button" tabindex="0"><i class="fa fa-shopping-cart"></i> <span>Sản phẩm</span></a></li>
                                <li <?php if ($_GET['controller']=='user') { ?> class="active" <?php } ?>><a href="admin.php?controller=user" role="button" tabindex="0"><i class="fa fa-user"></i><span>Users</span></a></li>
                                <li <?php if ($_GET['controller']=='order') { ?> class="active" <?php } ?>><a href="admin.php?controller=order" role="button" tabindex="0"><i class="fa fa-file-o"></i> <span>Đơn hàng</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
